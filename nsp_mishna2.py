...
X_train_tokenized = tokenizer(X_train.values.tolist(), padding=True, truncation=True, max_length=512)
X_val_tokenized = tokenizer(X_val.values.tolist(), padding=True, truncation=True, max_length=512)
